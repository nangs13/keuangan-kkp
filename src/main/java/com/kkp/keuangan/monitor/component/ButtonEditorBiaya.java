...
public class ButtonEditorBiaya extends DefaultCellEditor {
    private JButton button;
    private JTable table;
    private int selectedRow;

    public ButtonEditorBiaya(JCheckBox checkBox, JTable table) {
        super(checkBox);
        this.table = table;
    ...
    private void showDetailDialog(String BiayaCode) {
        BiayaDAO dao = new BiayaDAO();
        List<ModelBiaya> details = dao.findByCode(BiayaCode);
    ...
    public Object getCellEditorValue() {
        String BiayaCode = table.getValueAt(selectedRow, 0).toString();
        showDetailDialog(BiayaCode);
        return "Detail";
    }
